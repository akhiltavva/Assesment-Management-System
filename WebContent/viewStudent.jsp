<%@page import="com.ram.pojo.Student"%>
<%@page import="com.ram.pojo.StudentCurd"%>
<%@page import="java.util.Iterator"%>
<%@page import="com.ram.pojo.Faculty"%>
<%@page import="java.util.ArrayList"%>
<%@page import="com.ram.pojo.FacultyCurd"%>
<%@ include file="header.jsp" %>       <!-- ***** Header Area End ***** -->
              ...
              <div class="row">
                ...
                <h6>Faculty Information</h2><br>
                  ...
                  <table class="table">
                       ...
                       ArrayList<Student> al=sc.displayStudent();
                       ...
                       <tr>
                         ...
                         <td><%=s.getSection()%></td>
                          <td><%=s.getYear()%></td>
                         <td><a href="DeleteStudent?id=<%=s.getSid()%>">Delete</a></td>
